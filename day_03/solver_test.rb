...
describe Solver do
  ...
  describe 'part 1 - sum of priorities of repeated items' do
    ...
    #     assert_equal "vJrwpWtwJgWrhcsFMMfFFhFp", rucksack.all_items
    #     assert_equal "vJrwpWtwJgWr", rucksack.first_compartment
    #     assert_equal "hcsFMMfFFhFp", rucksack.second_compartment
    #   end
    #
    ...
    #     assert_equal "jqHRNqRjqzjGDLGL", rucksack.first_compartment
    #     assert_equal "rsFMfFZSrLrFZsSL", rucksack.second_compartment
    #   end
    #
    #   it 'finds repeated item in both compartments' do
    #     s = Solver.new(@input)
    ...
    #     assert_equal "PmmdzqPrV", rucksack.first_compartment
    #     assert_equal "vPwwTWBwg", rucksack.second_compartment
    #   end
    #
    #   it 'finds repeated item in both compartments' do
    #     s = Solver.new(@input)
